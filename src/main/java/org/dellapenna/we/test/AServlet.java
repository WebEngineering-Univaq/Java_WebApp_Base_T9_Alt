...
/**
 *
 * @author GDP here we use the @WebServlet annotation instead of the deployment
 * descriptor to declare the servlet name and path(s) qui usiamo l'annotazione
 * @WebServlet invece del deployment descriptor per dichiarare il nome e i path
 * della servlet
 */
@WebServlet(name = "Servlet1", urlPatterns = {"/aservletpath", "/another/servletpath", "/all/these/*"})
